...
export const ar = {
  ...
  "clarify.hint":
    "أوقف Gemini هذه الدفعة. أجب عن السؤال للمتابعة. تنتظر الدفعات المعلقة المتبقية حتى تنتهي هذه. يمكنك أيضًا إعادة المحاولة من البداية دون الإجابة.",
  ...
  "errors.hint":
    "دفعة فاشلة أو سؤال توضيحي يوقف التشغيل. لا تُرسل النطاقات المعلقة المتبقية. حدود المعدل تنتظر وتعيد محاولة الدفعة الحالية دون توقف. أعد محاولة صف فاشل، أو أجب عن توضيح، أو تكييف الكتاب لاستئناف الدفعات المعلقة. تبقى الدفعات المكتملة قابلة للتنزيل.",
  "errors.raw": "{raw}",
